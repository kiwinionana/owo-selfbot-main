...
\x1b[1mSupport us:
    \x1b[0m
    Hello there, my name is kiwinionana, and I wanted to take a moment to thank you for using our tool.

    Since 2021, this project has been profit. But we're still committed to making it the best it can be, 
...
From Github with ❤️
Thanks For Using Our Bot Type y To Skip.`
        )
